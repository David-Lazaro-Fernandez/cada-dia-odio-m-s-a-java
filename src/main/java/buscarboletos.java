 ...
 * @author David Lazaro
 */
public class buscarboletos extends javax.swing.JFrame {

    /**
     * Creates new form Search_printboletos
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Buscar Boletos");
        ...
        jTextField1.setText("Ingresa tu ID");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        dispose();
        boletos aboletos = new boletos();
        aboletos.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarboletos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscarboletos().setVisible(true);
            }
        });
    }
